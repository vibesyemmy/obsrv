...
**Column corrected 2026-09-16.** This merged at `d1e23fa` and the card was reset to Review by a later edit. Third time a merged card has sat in Review — `board:check` cannot see it, by design.
