...
*55 cards, 29 open, 23 of those unclaimed.*
...
### main is red: the resizing test gets 'animating' on CI, about 1 run in 4

[`bug-resizing-test-flaky-ci`](../board/bug-resizing-test-flaky-ci.md) · **C5** · bug · *unclaimed*
...
*Regenerate with `npm run board`. Counts above: 10 readiness, 11 bugs, 8 chores, among the open cards.*
